  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-card border border-zinc-300 dark:border-zinc-700 rounded-lg shadow-sm overflow-hidden">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 px-5 py-3.5 border-b border-border">
          <div className="flex items-center gap-2 bg-muted/50 border border-border rounded-md px-3 py-1.5 flex-1 max-w-sm">
        ...
        <div className="flex items-center gap-1.5 flex-wrap px-5 py-2.5 border-b border-border">
          {FILTERS.map((f) => (
            <button
              key={f}
              onClick={() => setStatus(f)}
